      ...
      <div className="section-light about-me" id="about-me">
        <div className="container">
          <div className="columns is-vcentered">
            ...
            <div className="column is-6 is-offset-1" data-aos="fade-left">
              <h1 className="title is-2">
                Temukan Penawaran dari Talenta Digital Kami!
              </h1>
              <br />
              <p>
                <a className="button is-medium is-info is-outlined" href="/catalog">
                  <i className="fas fa-search" aria-hidden="true"></i>Cari
                  disini
                </a>
              </p>
            </div>
